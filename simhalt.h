...
public:
	 ...
	 * @author Dwachs
	 */
    void fetch_goods( slist_tpl<ware_t> &load, const goods_desc_t *good_category, uint32 requested_amount, const vector_tpl<halthandle_t>& destination_halts, bool load_nearest_first = false);
